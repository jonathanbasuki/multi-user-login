...
<head>
	...
	<title>Student Dashboard | Multi User Login Template</title>
		...
		<div class="row my-3">
			<div class="col-md-8 offset-md-2">
				<div class="card text-center">
				  <div class="card-header bg-primary text-start text-light fw-light py-3">
				    <p class="fs-1 text-uppercase">Dashboard</p>
				    	<div class="d-flex justify-content-between">
				    		<p>Hello, <span class="fw-normal"><?= $_SESSION['nama_lengkap']; ?></span> | Student</p>
